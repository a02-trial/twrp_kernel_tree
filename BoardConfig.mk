...
# Crypto - disable biar size kecil (sama kayak a01core)
...
# ------------------------------------------------------------
# DIET MODE - Partisi cuma 24MB, mirip setup a01core
# ------------------------------------------------------------
...
# Kompresi LZMA untuk ramdisk
# Ini kombinasi maut sama kernel LZMA 7MB kamu
# Ramdisk ikut kecil = total image muat di 24MB
OF_USE_LZMA_COMPRESSION    := 1
BOARD_RAMDISK_USE_LZMA     := true
LZMA_RAMDISK_TARGETS       := recovery

# ------------------------------------------------------------
# Display - Samsung A02 720x1600 dengan punch-hole
# ------------------------------------------------------------
OF_SCREEN_H              := 1600
OF_CLOCK_POS             := 1
OF_STATUS_H              := 84
